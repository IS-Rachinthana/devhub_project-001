							...
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-check-inline disabled">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="Property Owner">Property Owner
									  </label>
									</div>
									<div class="form-group">
										<label class="col-form-label"><span class="text-secondary font-weight-bold"><b>Add Your Profile Image :</b></span></label>

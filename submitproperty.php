									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row mb-3">
													<label class="col-lg-3 col-form-label">Key Money Duration</label>
													<div class="col-lg-9">
														<select class="form-control" required name="bhk">
															...
															<option value="07 Month">07 Month</option>
															<option value="08 Month">08 Month</option>
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold" style="color:red">Property : </span>Brand New</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Property Age: </span>10 Years</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Swimming Pool : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Parking : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">GYM : </span>Yes</li>
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Type : </span>Apartment</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Security 24Hr : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Dining Capacity : </span>10 People</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Church/Temple  : </span>No</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Furniture Include : </span>No</li>
														
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Nearby SuperMarket : </span>No</li>
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">3rd Party : </span>No</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Elevator : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">CCTV : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold"style="color:red">Water Supply : </span>Ground Water / Tank</li>
														</ul>
													</div>
												<!---feature area end---->
											</textarea>
